...
export class Participant {
  ...
  constructor(id, tournamentId, firstName, lastName, birthDate, clubName, weight, nationality, genderId, gradeId) {
    ...
    this.nationality = nationality; // nationalite du participant
